...
var DashboardService = function () {
    ...
    var DashboardService = _classThis = /** @class */ (function () {
        ...
        DashboardService_1.prototype.getDashboard = function (currentUser) {
            return __awaiter(this, void 0, void 0, function () {
                var membersCount, eventsCount, invitesPending;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.prisma.membership.count({
                                    where: {
                                        associationId: currentUser.associationId,
                                    },
                                })];
                        case 1:
                            membersCount = _a.sent();
                        ...
                        case 2:
                            eventsCount = _a.sent();
                            return [4 /*yield*/, this.prisma.invite.count({
                                    where: {
                                        associationId: currentUser.associationId,
                                        status: 'PENDING',
                                    },
        ...
        DashboardService_1.prototype.getKpis = function (currentUser) {
            return __awaiter(this, void 0, void 0, function () {
                var associationId, _a, membersCount, eventsCount, registrationsCount, transactions, incomeCents, expenseCents;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _a = _b.sent(), membersCount = _a[0], eventsCount = _a[1], registrationsCount = _a[2], transactions = _a[3];
                            ...
                            return [2 /*return*/, {
                                    ...
                                    avgRevenuePerMember: membersCount > 0

...
var DashboardController = function () {
    var _classDecorators = [(0, common_1.Controller)('dashboard'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, association_active_guard_1.AssociationActiveGuard)];
    ...
    var DashboardController = _classThis = /** @class */ (function () {
        ...
        DashboardController_1.prototype.getDashboard = function (req) {
            return this.dashboardService.getDashboard(req.user);
        };
        DashboardController_1.prototype.getKpis = function (req) {

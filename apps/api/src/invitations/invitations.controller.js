...
var InvitationsController = function () {
    var _classDecorators = [(0, common_1.Controller)('invitations'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard)];
    ...
    var InvitationsController = _classThis = /** @class */ (function () {
        function InvitationsController_1(invitationsService) {
            this.invitationsService = (__runInitializers(this, _instanceExtraInitializers), invitationsService);
        }
        InvitationsController_1.prototype.create = function (req, dto) {
            return this.invitationsService.create(req.user, dto);
        };
        InvitationsController_1.prototype.findAll = function (req) {
            return this.invitationsService.findAll(req.user);
        };
        InvitationsController_1.prototype.accept = function (req, body) {
    ...
    (function () {
        ...
        _findAll_decorators = [(0, common_1.Get)(), (0, roles_decorator_1.Roles)('OWNER', 'ADMIN')];
        _accept_decorators = [(0, common_1.Post)('accept')];

...
var BillingController = function () {
    var _classDecorators = [(0, common_1.Controller)('billing'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, association_active_guard_1.AssociationActiveGuard, roles_guard_1.RolesGuard)];
    ...
    var BillingController = _classThis = /** @class */ (function () {
        ...
        BillingController_1.prototype.createCheckout = function (req) {
    ...
    (function () {
        ...
        _createCheckout_decorators = [(0, common_1.Post)('checkout'), (0, roles_decorator_1.Roles)('OWNER')];

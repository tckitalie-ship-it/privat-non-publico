...
var MembershipsService = function () {
    ...
    var MembershipsService = _classThis = /** @class */ (function () {
        function MembershipsService_1(prisma) {
            this.prisma = prisma;
        }
        MembershipsService_1.prototype.create = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                var _a;
                return __generator(this, function (_b) {
                    return [2 /*return*/, this.prisma.membership.create({
                            data: {
                                userId: dto.userId,
        ...
        MembershipsService_1.prototype.findAllByAssociation = function (associationId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.membership.findMany({
                            where: {

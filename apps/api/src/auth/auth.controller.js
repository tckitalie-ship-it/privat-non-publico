...
var AuthController = function () {
    ...
    var _switchAssociation_decorators;
    var _me_decorators;
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.switchAssociation = function (req, dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.switchAssociation(req.user.id, dto.associationId)];
                });
            });
        };
        AuthController_1.prototype.me = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.me(req.user.id)];
                });
            });
        };
    ...
    (function () {
        ...
        _switchAssociation_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Post)('switch-association')];
        ...
        __esDecorate(_classThis, null, _switchAssociation_decorators, { kind: "method", name: "switchAssociation", static: false, private: false, access: { has: function (obj) { return "switchAssociation" in obj; }, get: function (obj) { return obj.switchAssociation; } }, metadata: _metadata }, null, _instanceExtraInitializers);

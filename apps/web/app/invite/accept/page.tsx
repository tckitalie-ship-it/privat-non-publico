    ...
    <main className="flex min-h-screen items-center justify-center bg-[#0f1117] p-6">
      <div className="w-full max-w-md rounded-3xl border border-white/10 bg-[#1a1f2e] p-8 shadow-2xl">
        <h1 className="mb-6 text-center text-3xl font-bold text-white">
          {error ? 'Errore' : 'Registrazione invito'}
        </h1>

        {loading && <p className="text-center text-gray-300">{message}</p>}
        ...
        {!loading && !error && (
          <form onSubmit={registerAndAccept}>
            ...
            <input
              ...
              value={email}
              readOnly
              className="mb-4 w-full rounded-xl border border-white/10 bg-[#0f1117] p-3 text-gray-300 outline-none"
            />

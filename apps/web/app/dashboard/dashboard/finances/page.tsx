...
export default function FinancesPage() {
  ...
  async function loadTransactions() {
    try {
      ...
      if (!res.ok) {
        throw new Error('Errore caricamento finanze');
      }
      ...
      console.error(error);
      toast.error('Errore caricamento finanze');
      setTransactions([]);
    } finally {
  ...
  async function handleCreateTransaction(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      console.error(error);
      toast.error(error.message || 'Errore creazione movimento');
    } finally {
      setLoading(false);
    }
  }
        ...
        <div className="mx-auto max-w-7xl">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-3 text-zinc-400">
                  Gestisci entrate, uscite e saldo della tua associazione.
                </p>
              </div>
          ...
          <section className="mt-8 grid gap-5 md:grid-cols-3">
            <div className="rounded-3xl border border-white/10 bg-emerald-500/10 p-6">
              <p className="text-sm text-emerald-300">Entrate</p>
            ...
            <div className="rounded-3xl border border-white/10 bg-red-500/10 p-6">
              <p className="text-sm text-red-300">Uscite</p>
              <h2 className="mt-3 text-4xl font-bold">
            ...
            <div className="rounded-3xl border border-white/10 bg-indigo-500/10 p-6">
              <p className="text-sm text-indigo-300">Saldo</p>
              <h2 className="mt-3 text-4xl font-bold">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h3 className="font-semibold">
                          {transaction.description || 'Movimento'}
                        </h3>
